...
/**
 * print_listint_safe - function that  prints listint_t linked listtt..
 * @head: pointer to the head of linked listtt...
 *
 * This function can print lists with looopp...
 * You should go through the list only once...
 * If the function fails, exit the program with status 98.
 *
 * Return: the number of nodes in listtt....
 */
